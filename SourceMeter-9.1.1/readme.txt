...
C/C++, Java, C#, Python, JavaScript or RPG programming languages.
...
* Support for C++14, Java 8, C# 6.0, Python 2.7.x and 3.7.x, EcmaScript2017 (JavaScript), RPG III and IV
  (including free-form)
...
* Coding issue detection
  ...
  - Integration of popular free tools (Cppcheck, PMD, SpotBugs, FxCop, Pylint, ESLint)
...
which can be found in the CPP, Java, CSHARP, Python, JavaScript, and RPG subdirectories
of the package.
